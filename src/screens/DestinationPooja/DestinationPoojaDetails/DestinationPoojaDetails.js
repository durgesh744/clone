        ...
        <View style={{ flex: 1, backgroundColor: Colors.bodyColor }}>
            ...
            <View style={{ flex: 1 }}>
                ...
                <FlatList ListHeaderComponent={
                    <>
                        {DestinationPoojaBanner({ navigation, data })}
                        {DestinationPoojaDetail({ navigation, data })}
                    </>
                }
                />
            </View>
...
function DestinationPoojaBanner({ data }) {
    return (
        <View style={{ flex: 1 }}>
...
function DestinationPoojaDetail({ navigation, data }) {
